...
interface VatData extends PaginationType {
  vat: Vat[];
}
...
export function VatTable({
  ...
  const columns: ColumnDef<Vat>[] = React.useMemo(
    () => [
      {
        accessorKey: 'name',
        header: 'Name',
      ...
      },
      {
        ...
        cell: function ({ row }) {
          return (
            <div className="font-medium capitalize">{row.original.rate}</div>
          );
        },
      },
      {
